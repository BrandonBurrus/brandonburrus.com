module.exports = {
  ...
  rules: {
    ...
    'max-classes-per-file': ['error', 1], // (configurable) Maximum number of classes allowed per file
    ...
    'no-unused-expressions': 'warn', // No blank expressions
    ...
    'no-shadow': 'error', // No variables that shadow higher scoped variables
    ...
    'func-names': ['warn', 'as-needed'], // Functions need to be named
    ...
    'id-length': ['warn', { min: 2, max: 32, exceptions: ['_'] }], // How small/large identifiers may be
    ...
    'max-lines': ['warn', 250], // Maximum number of lines per file
    ...
    'no-nested-ternary': 'warn', // No combining multiple ternary operations together (hard to read)
    ...
    'no-underscore-dangle': 'warn', // No starting/ending identifiers with _
    ...
    'no-dupe-class-members': 'error', // No class members that have the same identifier
    ...
    'require-yield': 'error', // Generator functions must have a yield statement
    ...
    'import/namespace': 'error', // Wildcard import identifiers are valid when dereferenced
    ...
    'jsx-a11y/no-static-element-interactions': 'warn', // Any elements that have interactions also need to have roles
    ...
    'promise/catch-or-return': 'warn', // Ensure .then() returns to always have promise chains
